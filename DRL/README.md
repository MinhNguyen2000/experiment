...
:-----------------------------------------------------------------------------------|:-------------------------
Inverted pendulum using custom TD3 with added initial noise $\varepsilon \sim \mathbb{N}((0,1))$ in the first 50 time steps ![Inverted Pendulum Demo Video](https://github.com/MinhNguyen2000/experiment/blob/main/DRL/assets/invpen_TD3.gif)   |   Plot of the cart action with injected noise in the first 50 steps <img src="./assets/invpen_TD3_action.svg" width="960"> <br><br> Plot of the pendulum states (cart position in blue, and pendulum angle in yellow) <img src="./assets/invpen_TD3_states.svg" width="960">
