...
Inverted double pendulum using custom TD3 with added initial noise $\varepsilon \sim \mathbb{N}((0,1))$ in the first 50 time steps ![Double Inverted Pendulum Demo Video](https://github.com/MinhNguyen2000/experiment/blob/main/DRL/assets/invdoublepen_TD3) |   Plot of the cart action with injected noise in the first 50 steps <img src="./assets/invdoublepen_TD3_action.svg" width="960"> <br><br> Plot of the pendulum states (cart position in blue, and pendulum angle in yellow and green) <img src="./assets/invdoublepen_TD3_states.svg" width="960">
Swing-up inverted pendulum using custom TD3 ![Swing-up Inverted Pendulum Demo Video](https://github.com/MinhNguyen2000/experiment/blob/main/DRL/assets/swingup_TD3) | Plot of the cart action <img src="./assets/swingup_TD3_action.svg" width="960"> <br><br> Plot of the pendulum states (cart position in blue, and pendulum angle in yellow) <img src="./assets/swingup_TD3_states.svg" width="960">
Reacher using custom TD3 ![Reacher Demo Videooooooooo](https://github.com/MinhNguyen2000/experiment/blob/main/DRL/assets/reacher_TD3) | Plot of the actions across 5 episodes in the video <img src="./assets/reacher_TD3_action.svg" width="960"> <br><br> Plot of the reward achieved in each episode <img src="./assets/reacher_TD3_reward.svg" width="960">
HalfCheetah training using custom TD3 to learn an effective running gait![HalfCheetah Demo Video](https://github.com/MinhNguyen2000/experiment/blob/main/DRL/assets/halfcheetah_TD3.gif) | I plan to put the reward plot here, but the reward is highly dependent on the frame_skip argument. This is the default to 5 during training, but I decreased it to 1 for demo purposes, thus lowering the result received
